    ...
    <div>
        <div className="relative">
          <div className="absolute inset-0 bg-black opacity-50"></div>
            ...
            <h1 className="absolute top-24 text-2xl ml-4 sm:text-4xl sm:top-40 md:text-5xl md:top-56 lg:text-7xl text-white lg:top-80 lg:ml-10 font-semibold">{title}</h1>
